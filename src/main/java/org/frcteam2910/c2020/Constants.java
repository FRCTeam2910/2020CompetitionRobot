...
public class Constants {
    ...
    public static final int SHOOTER_DRIVE_MOTOR_PORT_1 = 16;
    public static final int SHOOTER_DRIVE_MOTOR_PORT_2 = 15;
    ...
    public static final int WHEEL_OF_FORTUNE_MOTOR_PORT = 0;
